...
const UserConnections = ({getConnections, userConnections: {userConnections, loading}}) => {
        useEffect(() => {
                getConnections();
        }, [getConnections]);
        ...
        return(
                loading && userConnections === null ? <Spinner /> : <Fragment>
                        <div className="container my-5">
                                <h1 className="large text-primary">My Connections</h1>
                                <p className="lead mb-5">
                                        <i className="fab fa-connectdevelop"/> Browse through your connections and find out about their latest posts
                                </p>

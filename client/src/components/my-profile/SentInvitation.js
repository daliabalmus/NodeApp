        ...
        const profile = sentInvitations.map((invitation, i) => (
                <div key={invitation._id} className="profile bg-white border box-shadow">
                        ...
                        <div>
                                ...
                                <Link to={"/profile/" + invitation.user._id} className="btn btn-outline-primary">View Profile</Link>
                        </div>
                        <div className="text-center">
                                <Link to="/my-profile" className="btn btn-sm btn-danger">Delete invitation</Link>
                        </div>

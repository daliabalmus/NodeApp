        ...
        return <Fragment>
                ...
                <section className="container my-5">
                        ...
                        <div className="profile-info position-relative">
                                <div className="btn-primary btn connect-user-button px-5" onClick={e => {sendConnection(profile.user._id)}}>Connect</div>
                        ...
                        <div className="my-4">
                                ...
                                <div className="bg-white border p-4 box-shadow text-center mt-4">
                                        <h3 className="text-primary">{profile.user.name ? profile.user.name : ""}'s Bio</h3>
...
export default connect(mapStateToProps, {getProfileUserId, connectionRequest})(UserProfile);
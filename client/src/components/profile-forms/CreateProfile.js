                ...
                <div className='container py-5'>
                        ...
                        <form className="form" onSubmit={e => onSubmit(e)}>
                                <div className="form-group">
                                        <select name="status" className='py-3 px-2 text-muted' value={status} onChange={e => onChange(e)}>
                                ...
                                <div className="form-group">
                                        <textarea className='form-control' placeholder="A short bio of yourself" name="bio" value={bio} onChange={e=> onChange(e)}></textarea>
